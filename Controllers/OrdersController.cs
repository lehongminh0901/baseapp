...
namespace demoasm2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var userContext = _context.Order.Include(o => o.User).Include(o=>o.OrderDetails)
                .Where(o=> o.UId == user.Id);
        ...
        public IActionResult Create(string id)
        {
            ...
            OrderDetail oderDetail = new OrderDetail() { BookIsbn = id, Quantity = 1, OrderId = order.Id };
        ...
        //    }
        //    ViewData["UId"] = new SelectList(_context.Users, "Id", "Id", order.UId);
        //    return View(order);
        //}
